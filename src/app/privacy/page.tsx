...
const content = {
  en: {
    ...
    s2_2: "2.2 Class Bookings (our booking platform)",
    s2_2p: "When you book a class, you interact with our booking platform, a third-party booking platform. our booking platform collects your name, email address, phone number, payment information, and booking history. our booking platform acts as an independent data controller for data processed through its platform. Please refer to",
    s2_2p2: "our booking platform\u2019s privacy policy",
    s2_2p3: "for details.",
    ...
    s5r3c1: "Our booking platform", s5r3c2: "Class booking and payments", s5r3c3: "France (EU)",
  ...
  fr: {
    ...
    s2_2: "2.2 Réservations de cours (our booking platform)",
    s2_2p: "Lorsque vous réservez un cours, vous interagissez avec our booking platform, une plateforme de réservation tierce. our booking platform collecte votre nom, adresse e-mail, numéro de téléphone, informations de paiement et historique de réservation. our booking platform agit en tant que responsable de traitement indépendant pour les données traitées via sa plateforme. Veuillez consulter",
    s2_2p2: "la politique de confidentialité de our booking platform",
    ...
    s5r3c1: "Our booking platform", s5r3c2: "Réservations et paiements", s5r3c3: "France (UE)",
  ...
  es: {
    ...
    s2_2: "2.2 Reservas de clases (our booking platform)",
    s2_2p: "Cuando reserva una clase, interactúa con our booking platform, una plataforma de reservas de terceros. our booking platform recopila su nombre, dirección de correo electrónico, número de teléfono, información de pago e historial de reservas. our booking platform actúa como responsable del tratamiento independiente para los datos procesados a través de su plataforma. Consulte",
    s2_2p2: "la política de privacidad de our booking platform",
    ...
    s5r3c1: "Our booking platform", s5r3c2: "Reservas y pagos", s5r3c3: "Francia (UE)",
  ...
  de: {
    ...
    s2_2: "2.2 Kursbuchungen (our booking platform)",
    s2_2p: "Wenn Sie einen Kurs buchen, interagieren Sie mit our booking platform, einer Drittanbieter-Buchungsplattform. our booking platform erhebt Ihren Namen, Ihre E-Mail-Adresse, Telefonnummer, Zahlungsinformationen und Buchungshistorie. our booking platform agiert als eigenständiger Verantwortlicher für die über seine Plattform verarbeiteten Daten. Bitte beachten Sie",
    s2_2p2: "die Datenschutzerklärung von our booking platform",
    ...
    s5r3c1: "Our booking platform", s5r3c2: "Kursbuchung und Zahlungen", s5r3c3: "Frankreich (EU)",
          ...
          <div className="prose-legal space-y-12">
            ...
            <div>
              ...
              <p className="text-stone leading-relaxed text-sm">
                {c.s2_2p}{" "}
                <a href="https://www.nimarapilates.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-green hover:text-green-light transition-colors">{c.s2_2p2}</a>{" "}
                {c.s2_2p3}
              </p>
