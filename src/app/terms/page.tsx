...
const content = {
  en: {
    ...
    s3_1: "3.1 Booking",
    s3_1p: "All class bookings are made through our booking platform. You must create an account with us to book classes. By booking a class, you agree to our booking platform\u2019s terms of service in addition to these Terms.",
    ...
    s3_3: "3.3 Waitlist",
    s3_3p: "If a class is full, you may join the waitlist through our booking app. If a spot becomes available, you will be automatically enrolled and notified. Standard cancellation terms apply once you are enrolled.",
    s4: "4. Pricing and Payment",
    s4b1: "All prices are displayed in Euros and include applicable taxes (IVA).",
    s4b2: "Payment is processed securely through our booking app at the time of purchase.",
    ...
    s7b3: "We are not responsible for the content, policies, or practices of third-party platforms (WhatsApp, etc.).",
  ...
  fr: {
    ...
    s3_1p: "Toutes les réservations de cours sont effectuées via notre plateforme our booking platform. Vous devez créer un compte sur notre plateforme pour réserver des cours. En réservant un cours, vous acceptez les conditions d\u2019utilisation de our booking platform en plus des présentes CGV.",
    ...
    s3_3p: "Si un cours est complet, vous pouvez rejoindre la liste d\u2019attente via our booking app. Si une place se libère, vous serez automatiquement inscrit et notifié. Les conditions d\u2019annulation standard s\u2019appliquent dès votre inscription.",
    s4: "4. Tarifs et paiement",
    s4b1: "Tous les prix sont affichés en euros et incluent les taxes applicables (IVA).",
    s4b2: "Le paiement est traité de manière sécurisée via our booking app au moment de l\u2019achat.",
    ...
    s7b3: "Nous ne sommes pas responsables du contenu, des politiques ou des pratiques des plateformes tierces (WhatsApp, etc.).",
  ...
  es: {
    ...
    s3_1: "3.1 Reserva",
    s3_1p: "Todas las reservas de clases se realizan a través de nuestra plataforma de reservas. Debe crear una cuenta con nosotros para reservar clases. Al reservar, acepta los presentes Condiciones.",
    ...
    s3_3p: "Si una clase está completa, puede unirse a la lista de espera a través de nuestra plataforma. Si se libera una plaza, quedará inscrito automáticamente y recibirá notificación. Las condiciones de cancelación estándar se aplican desde el momento de la inscripción.",
    s4: "4. Precios y pago",
    s4b1: "Todos los precios se muestran en euros e incluyen los impuestos aplicables (IVA).",
    s4b2: "El pago se procesa de forma segura a través de nuestra plataforma en el momento de la compra.",
    ...
    s7b3: "No somos responsables del contenido, las políticas ni las prácticas de plataformas de terceros (WhatsApp, etc.).",
  ...
  de: {
    ...
    s3_1: "3.1 Buchung",
    s3_1p: "Alle Kursbuchungen erfolgen über unsere Buchungsplattform. Sie müssen ein Konto bei unserer Plattform erstellen, um Kurse buchen zu können. Mit der Buchung eines Kurses stimmen Sie den Nutzungsbedingungen zusätzlich zu diesen AGB zu.",
    ...
    s3_3: "3.3 Warteliste",
    s3_3p: "Wenn ein Kurs ausgebucht ist, können Sie sich über unsere Buchungs-App auf die Warteliste setzen lassen. Wenn ein Platz frei wird, werden Sie automatisch eingeschrieben und benachrichtigt. Die üblichen Stornierungsbedingungen gelten ab dem Moment Ihrer Einschreibung.",
    s4: "4. Preise und Zahlung",
    s4b1: "Alle Preise werden in Euro angegeben und enthalten die anfallenden Steuern (IVA).",
    s4b2: "Die Zahlung wird zum Zeitpunkt des Kaufs sicher über unsere Buchungs-App abgewickelt.",
    ...
    s7b3: "Wir sind nicht verantwortlich für Inhalte, Richtlinien oder Praktiken von Drittanbieterplattformen (WhatsApp usw.).",
