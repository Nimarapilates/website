...
const content = {
  en: {
    ...
    s7p1: "All late cancellation and no-show fees are payable within 24 hours of the cancellation or missed session. Payment may be made via the contacting the studio directly.",
  ...
  fr: {
    ...
    s7p1: "Tous les frais d\u2019annulation tardive et d\u2019absence sont dus dans les 24 heures suivant l\u2019annulation ou la séance manquée. Le paiement peut être effectué en contactant directement le studio.",
  ...
  es: {
    ...
    s7: "7. Pago de cargos",
    s7p1: "Todos los cargos por cancelación tardía o ausencia son pagaderos en las 24 horas siguientes a la cancelación o sesión perdida. El pago puede realizarse contactando directamente con el estudio.",
  ...
  de: {
    ...
    s7p1: "Alle Gebühren für Spätstornierungen und Nichterscheinen sind innerhalb von 24 Stunden nach der Stornierung oder der verpassten Einheit zu zahlen. Die Zahlung kann direkt beim Studio erfolgen.",
